    ...
    <section className="bg-gradient-to-br from-[#0b2545] via-[#1e3a5f] to-[#0b2545] text-white py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <p className="text-green-400 text-sm font-semibold uppercase tracking-widest mb-4">
          🇬🇧 UK Lojistik Partneri
        </p>

        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight text-balance mb-6">
          UK Depolama ve{" "}
          <span className="text-red-400">Fulfillment</span> Hizmeti
        </h1>

        <p className="text-slate-300 text-lg md:text-xl leading-relaxed mb-8 max-w-3xl mx-auto">
          Ürünlerinizi Londra'daki depomuzda saklayın, operasyonel süreçlerinizi bize bırakın.
          Gümrükleme desteğinden Shopify ve Amazon fulfillment'a, pick &amp; pack'ten
          İngiltere geneli teslimatına kadar LondraDepo, UK lojistik süreçlerinizi
          tek noktadan yönetmenize yardımcı olur.
        </p>
