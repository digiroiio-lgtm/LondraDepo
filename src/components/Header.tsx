    ...
    <header className="sticky top-0 z-50 bg-[#0b2545] shadow-lg">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <a
            href={TEL}
            className="hidden sm:inline-flex items-center gap-1 text-sm text-slate-200 hover:text-white transition"
          >
            📞 Ara
          </a>
          <a
            ...
            className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white text-sm font-semibold px-4 py-2 rounded-full transition"
          >
