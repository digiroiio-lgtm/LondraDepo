      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-green-500 hover:bg-green-400 active:bg-green-600 text-white font-extrabold px-10 py-5 rounded-2xl text-lg transition shadow-2xl ring-2 ring-green-400/60"
          >
          ...
          <a
            href={TEL}
            className="inline-flex items-center justify-center gap-3 bg-white hover:bg-slate-100 active:bg-slate-200 text-[#0b2545] font-bold px-10 py-5 rounded-2xl text-lg transition shadow-xl border-2 border-white"
          >
            <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
